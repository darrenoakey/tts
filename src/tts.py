        ...
        if custom:
            ...
            if designed:
                ...
                for v, info in designed:
                    ...
                    suffix = (
                        f" {Fore.GREEN}(fast){Style.RESET_ALL}" if is_clone else f" {Fore.RED}(slow){Style.RESET_ALL}"
                    )
                    print(
                        f"  {Fore.WHITE}•{Style.RESET_ALL} {Fore.GREEN}{v}{Style.RESET_ALL}: {Fore.WHITE}{desc[:50]}...{Style.RESET_ALL}{suffix} {Style.DIM}(speed: {speed}){Style.RESET_ALL}"
                    )
            if cloned:
                ...
                for v, info in cloned:
                    ...
                    speed = info.get("speed", 1.0)
                    print(
                        f"  {Fore.WHITE}•{Style.RESET_ALL} {Fore.GREEN}{v}{Style.RESET_ALL}: ref={Fore.CYAN}{Path(ref_audio).name}{Style.RESET_ALL} {Style.DIM}(speed: {speed}){Style.RESET_ALL}"
                    )
        print()
        return 0
